  ...
  return (
   <>
    <div className='screenseven py-4 flex flex-col justify-center items-center'>
       ...
       <p className='py-4 mt-4'>If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at royallyrummysocial@gmail.com. Our Disclaimer was generated with the help of the Free Disclaimer Generator.</p>
