...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    {screenSize <= 1000 ? <NavbarMobile/> : <Navbar/>}
        ...
        <div className='container px-3 py-4 lg:px-0'>
       <div className=' bg-[#040055] text-white py-5 rounded-lg w-full flex items-center justify-center'>
       <h1 className='text-[20px] lg:text-[24px] font-bold pl-5 lg:pl-0'>Privacy Policy</h1>
       </div>
        <h2 className='text-[18] lg:text-[20px] mt-4 py-4 font-bold text-left'>We're Here to Help</h2>
       <p className='py-4'>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
</p>
<p className='We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.
'></p>
       <h2  className='text-[18] lg:text-[20px] py-4 font-bold text-left'>Interpretation and Definitions
</h2>
